...
import { evaluateAutoApplyPromotions } from "./evaluate-auto-apply-promotions"
import { computeNonStandardAdjustments } from "./compute-non-standard-adjustments"

export async function cartUpdatedHandler(cartId: string, container: MedusaContainer): Promise<void> {
