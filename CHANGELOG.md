...
- 151d2e9: Recompute a promoted order's discount when an order edit is confirmed.
...
- e0e8e5c: Stop bundle and buy-get discounts from driving a cart line below zero.
...
- 938c27a: Declare `react-hook-form` (`^7.55.0`) as a peerDependency — host apps must now supply it.
